...
insert into block (u_id, datum,  reason)
values (1001, now() + interval '1 hour', 'В предел охуевший!'),
       (1001, '2019-03-22 09:00:00', 'Охуевший не то слово'),
       (1001, '2019-03-22 15:00:00', 'Опухший'),
       (1001, '2019-03-23 15:00:00', 'Опухший в край');
