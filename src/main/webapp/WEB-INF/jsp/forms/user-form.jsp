...
<form id="user-detailsForm">
    ...
    <div class="form-group row">
        <label for="name" class="col-4 col-form-label">Имя<spring:message code="app.asteriks"/></label>
        <div class="col-8" id="name-div">
            <input type="text" id="name" name="name" class="form-control" required="required"/>
        </div>
    </div>
    <div class="form-group row">
        <label for="adresse" class="col-4 col-form-label">Адрес<spring:message code="app.asteriks"/></label>
        <div class="col-8" id="adresse-div">
            <input type="text" id="adresse" name="adresse" class="form-control" required="required"/>
        </div>
    </div>
    <div class="form-group row">
        <label for="email" class="col-4 col-form-label">E-Mail<spring:message code="app.asteriks"/></label>
